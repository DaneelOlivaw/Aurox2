def registrouscnv(finestra, stallaoper, anno)
	...
	#			destinazione = i.destinazione
		...
		foglio.bounding_box([0, foglio.cursor], :width => 820) do
			...
			foglio.table(data, :column_widths => [39, 76, 33, 33, 76, 25, 52, 52, 106, 34, 52, 111, 76, 55], :cell_style => {:size => 8, :padding => [2, 2]}, :header => true) #, :width => 1000)
		end
		...
		foglio.render_file "#{@dir}/regnv/registro_uscitanv.pdf"
		if @sistema == "linux"
